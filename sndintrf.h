...
// shim for later MAME compatibility
typedef	INT16 stream_sample_t;

enum
{
	SNDINFO_PTR_SET_INFO,
	SNDINFO_PTR_START,
	SNDINFO_PTR_STOP,
	SNDINFO_PTR_RESET,
	SNDINFO_STR_NAME,
	SNDINFO_STR_CORE_FAMILY,
	SNDINFO_STR_CORE_VERSION,
	SNDINFO_STR_CORE_FILE,
	SNDINFO_STR_CORE_CREDITS
};
...
// sound attributes flags
#define SOUND_SUPPORTS_STEREO 1
