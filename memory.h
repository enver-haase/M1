...
#define cpu_readport16(x) memory_readport8(x)
#define cpu_writeport16(x, y) memory_writeport8(x, y)
#define cpu_readmem16(x) memory_read8(x)
#define cpu_readop16(x) memory_readop8(x)
#define cpu_writemem16(x, y) memory_write8(x, y)
...
/* various public utility and setup functions */
...
data8_t memory_readport8(offs_t address);
void memory_write8(offs_t address, data8_t data);
void memory_writeport8(offs_t address, data8_t data);
